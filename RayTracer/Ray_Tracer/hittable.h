...
public:
    ...
    //new functions for direct sampling
...
public:
    ...
    virtual bool hit(const ray& r, double t_min, double t_max, hit_record& rec) const override
    {
        ...
        vec4 O = vec4(r.orig, 1);
        vec4 D = vec4(r.dir, 0);
        vec4 o = inverseTransformMatrix.multiplyVec4(O);
        vec4 d = inverseTransformMatrix.multiplyVec4(D);
        vec3 rayOrigin(o.x(), o.y(), o.z());
        vec3 rayDir(d.x(), d.y(), d.z());

    	//vec3 rayOrigin = inverseTransformMatrix.multiplyVectorMatrix(O);
       ...
       // rayDir = unit_vector(rayDir);
        ...
        {
            vec4 n = inverseTransformMatrix.returnTransposed().multiplyVec4(vec4(rec.normal, 0));
            rec.normal = unit_vector(vec3(n.x(),n.y(),n.z()));
        	return true;
        }
    	return false;
    }
